...
SwiftUniversalFoundation provides a tiny extension on `Data` to enforce newline discipline:
...
These helpers are used by SwiftUniversalFoundation’s JSON writers:
