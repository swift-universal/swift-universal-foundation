...
SwiftUniversalFoundation supplies Foundation‑backed JSON defaults that complement the portable contracts in SwiftUniversalMain.
...
Bridge to SwiftUniversalMain’s portable `JSON.Parser` using these defaults:
